...
= 1.0.4 =
* Elementor background images now load from the CDN. Elementor's cached CSS is refreshed automatically after offloading or connecting.
* Connection errors now show the exact reason returned by FastCloudWP instead of a generic message.
* Fixed the email quick start so your site key is saved when connecting.

= 1.0.3 =
*  Start offloading in seconds by entering your email directly in the plugin, no account creation required.
