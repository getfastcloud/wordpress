...
Contributors: fastcloudwp
Tags: media, cdn, offload, cloud storage, performance, amazon, s3, cloudflare, media library
...
**No AWS. No IAM. No S3 buckets. No storage configuration.** Just create a FastCloudWP account, paste your site key into the plugin, and you're done. Everything else is handled for you, including a **5 GB free plan, unlimited sites, no time limit**.
