...
const buttonVariants = cva(
    'tw:inline-flex tw:items-center tw:justify-center tw:rounded-md tw:font-medium tw:text-center tw:max-w-full tw:no-underline',
    {
      variants: {
        variant: {
...
const { as, type, href, target, variant, size, loading } = toRefs(props)
</script>
